      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="Mechanical.php" >
...
//set up database and table names
 ...
 $result = mysqli_query($connection,"SELECT * FROM $table_name where Organizer='Mechanical Engineering'");
     ...
     $ename=$row['Event_Name'];
                                    ...
                                    echo '<div class="col-lg-4 col-md-4 col-sm-4 mb">
                                            <div class="content-panel pn">
                                                ...
                                                echo'</div>';
                                                echo'<a href="Participants.php?ename=';echo $ename; echo'"';echo'>';
                                                echo'    <div class="profile-01 centered" >';
                                                        echo'<p>SHOW PARTICIPANTS</p>
                                                    </div>
                                                </a>';
